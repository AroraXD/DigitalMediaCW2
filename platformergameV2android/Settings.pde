...
text("A/Left = left",width*0.5-width,height*0.3);
text("D/Right = right",width*0.5-width,height*0.4);
text("W/spacebar/Up = jump",width*0.5-width,height*0.5);
text("1 = pause",width*0.5-width,height*0.6);
text("esc = quit",width*0.5-width,height*0.7);
if (mousePressed)
gamecontrol = false;
  }
